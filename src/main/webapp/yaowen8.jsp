        ...
        <div class="w1200">
            <div class="chanye clearFloat">
                ...
                <div class="cright floatRight">
                    <h3 class="f24 text-33 border-d-b-d9d9d9 pb15 relative">青宁管道创管径最大距离最长穿越纪录<span class="kaiyuan"><span>来源：中国石化报</span>&nbsp;&nbsp;<span>发布时间：2020-11-06</span></span></h3><br>
                    <div class="crightpp">
                        <p>     &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; 9月5日，集团公司重点工程青宁（青岛-南京）输气管道工程EPC二标段G40沪陕高速公路穿越一次成功，穿越距离和管径均创集团公司管道穿越施工新纪录，为工程按时中交奠定基础。
                        </p><br>
                        <p class="text-center"><img src="images/new8.jpg" alt=""/></p><br>
