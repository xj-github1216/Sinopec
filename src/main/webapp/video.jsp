                ...
                <div class="cright floatRight">
                    ...
                    <div class="wmdxul">
                        <ul class="clearFloat">
                            <a href="video-ny.jsp">
                                <li>
                                    <embed src="http://player.youku.com/player.php/sid/XMTA5ODYyNjYw/v.swf" allowFullScreen="true" quality="high" width="265" height="195" align="middle" allowScriptAccess="always" type="application/x-shockwave-flash"></embed>
                                </li>
                            </a>
                            <a href="video-ny.jsp">
                                <li>
                    ...
                    <div class="newpage mt50">
                        <a href="" class="newfirst">|<<</a>
                        <a href=""><</a>
                        <a href="" class="newactive">1</a>
                        <a href="">2</a>
                        <a href="">></a>
                        <a href="" class="newfirst newlast">>>|</a>
                    </div>
