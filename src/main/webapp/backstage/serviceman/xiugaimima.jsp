        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                <hr>
                <form method="post" action="${pageContext.request.contextPath}/message?peopleStyle=serviceman&style=updatePassword&id=<%=serviceman.getServicemanId()%>" class="site-form">
