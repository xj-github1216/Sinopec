            ...
            <div class="card">
              <div class="card-toolbar clearfix">
                  ...
                  <div class="input-group">
                    <div class="input-group-btn">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li> <a tabindex="-1" href="javascript:void(0)" data-field="title">员工Id</a> </li>
                ...
                <div class="toolbar-btn-action">
                  <a class="btn btn-primary m-r-5" href="zhandianRenyuanAdd.html"><i class="mdi mdi-plus"></i> 新增故障报修</a>
                  <a class="btn btn-danger" href="#!"><i class="mdi mdi-window-close"></i> 删除故障报修</a>
                </div>
              </div>
              <div class="card-body">
