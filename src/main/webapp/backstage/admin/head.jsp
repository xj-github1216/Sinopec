    ...
    <div class="lyear-layout-sidebar-scroll">
        ...
        <nav class="sidebar-main">
            <ul class="nav nav-drawer">
                <li class="nav-item active"> <a href="adminHoutaiIndex.jsp"><i class="mdi mdi-home"></i> 后台首页</a> </li>
                ...
                <li class="nav-item nav-item-has-subnav">
                    <a href="javascript:void(0)"><i class="mdi mdi-format-align-justify"></i>公司人员管理</a>
                    <ul class="nav nav-subnav">
                        <li> <a href="zhandianrenyuan.jsp">站点人员列表</a> </li>
                        <li> <a href="yunweirenyuan.jsp">运维人员列表</a> </li>
                    </ul>
                </li>
                <li class="nav-item nav-item-has-subnav">
                    <a href="javascript:void(0)"><i class="mdi mdi-format-align-justify"></i>部门管理</a>
                    <ul class="nav nav-subnav">
                        <li> <a href="station.jsp">站点列表</a> </li>
                        <li> <a href="repairCom.jsp">运维列表</a> </li>
                    </ul>
                </li>
                <li class="nav-item nav-item-has-subnav">
                    <a href="javascript:void(0)"><i class="mdi mdi-file-outline"></i> 故障分类管理</a>
                    <ul class="nav nav-subnav">
                        <li> <a href="guzhangfenlei.jsp">故障分类列表</a> </li>
                    </ul>
                </li>
                <li class="nav-item nav-item-has-subnav">
            ...
            <ul class="topbar-right">
                <li class="dropdown dropdown-profile">
                    <a href="javascript:void(0)" data-toggle="dropdown">
                        <span style="font-size: x-large">欢迎进入管理员界面<span class="caret"></span></span>
                    </a>
