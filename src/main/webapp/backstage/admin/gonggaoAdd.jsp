      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-6" style="width: 1500px;height: 650px;">
            <div class="card">
              <div class="card-header"><h4>公告添加</h4></div>
              <div class="card-body">
                
                <form class="form-horizontal" action="${pageContext.request.contextPath}/gongGaoAdd" method="post" enctype="multipart/form-data">
				  
				  <!-- 标题-->
                  <div class="form-group">
                    <label class="col-xs-12" for="example-text-input">标题</label>
                    <div class="col-xs-12">
                      <input class="form-control" type="text" id="example-text-input" name="title" placeholder="标题..">
                    </div>
                  </div>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-xs-12">
				      <textarea class="form-control" id="example-textarea-input" name="content" rows="6" placeholder="公告内容.."></textarea>
				    </div>
				  </div>
