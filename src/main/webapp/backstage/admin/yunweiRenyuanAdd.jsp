      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-6" style="width: 1500px;height: 600px;">
            <div class="card">
              <div class="card-header"><h4>运维人员添加</h4></div>
              <div class="card-body">
                
                <form class="form-horizontal" action="${pageContext.request.contextPath}/peopleAdd?people=serviceman" method="post">
				  ...
				  <!-- 运维编号 -->
				  <div class="form-group">
				    <label class="col-xs-12" for="repair_id">运维公司编号</label>
				    <div class="col-xs-12">
