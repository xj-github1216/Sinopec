      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-6" style="width: 1500px;height: 600px;">
            <div class="card">
              <div class="card-header"><h4>运维公司添加</h4></div>
              <div class="card-body">
                
                <form class="form-horizontal" action="${pageContext.request.contextPath}/comAdd?comStyle=repairCom" method="post" id="stationAddForm">
				  
				  <!-- 站点地址 -->
                  <div class="form-group">
                    <label class="col-xs-12" for="address">运维公司地址</label>
                    <div class="col-xs-12">
                      <input class="form-control" type="text" id="address" name="address" placeholder="请输入运维公司地址">
                    </div>
                  </div>
				    ...
				    <div class="col-xs-12">
                        <select name="masterId" id="masterId">
                            ...
                            <c:forEach items="${servicemanList}" var="serviceman">
                                <option value="${serviceman.servicemanId}">${serviceman.servicemanId}  ${serviceman.name}</option>
                            </c:forEach>
                        </select>
